...
class Solver:
    def initialize(self, simulation, n, d, q, split, border):
...
solver = Solver()
solver.initialize(False, -1, -1, -1, -1, -1)
solver.solve()
...
#                 for _ in range(loop):
#                     solver = Solver()
#                     solver.initialize(True, n, d, q, split, border)
#                     score += solver.solve()
#                 mean = score // loop
#                 if best_score > mean:
#                     best_split = split
...
#         for _ in range(loop):
#             solver = Solver()
#             solver.initialize(True, 65, -1,-1, split, b)
